  ...
  return (
    <div id='layout'>
      ...
      <article id='as-article'>
        ...
        <p className="p-art">
          During her recuperation, she suddenly awoke one morning ere the breaking of the dawn to find herself with an unquenchable thirst.  The thirt, driving her towards
           the point of maddness saw her rise from her bedding, crutch under arm, and forge a path towards the cafeteria. While in the cafetaria, she happened upon a young man
           adorned in a light linen gown named Gary.  Gary introduced Twyla to the ambrosia of the gods; coffee.  This fateful happenstance would render the  
